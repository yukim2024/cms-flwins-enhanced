...
import { OMNIDEF } from './serviceNeedsMultiLanguage_def.js';
import tmpl from './serviceNeedsMultiLanguage.html';
import tmpl_nds from './serviceNeedsMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class serviceNeedsMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
