...
import { OMNIDEF } from './serviceGoalsMultiLanguage_def.js';
import tmpl from './serviceGoalsMultiLanguage.html';
import tmpl_nds from './serviceGoalsMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class serviceGoalsMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
