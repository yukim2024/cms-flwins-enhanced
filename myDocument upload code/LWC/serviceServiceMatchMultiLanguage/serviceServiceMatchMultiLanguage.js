...
import { OMNIDEF } from './serviceServiceMatchMultiLanguage_def.js';
import tmpl from './serviceServiceMatchMultiLanguage.html';
import tmpl_nds from './serviceServiceMatchMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class serviceServiceMatchMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
